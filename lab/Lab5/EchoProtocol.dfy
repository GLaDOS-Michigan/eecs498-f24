...
module ServerHost {
  ...
  datatype Constants = Constants(numClients: nat)

  // What relationship must hold between this host's own constants and the
  // structure of the overall group of hosts? It needs to know its hostId.
  ghost predicate ConstantsValidForGroup(c: Constants, numClients: nat)
  {
/*{*/
    && c.numClients == numClients
/*}*/
  }
...
module Host {
  ...
  {
    ghost predicate WF(c: Constants) {
      && (ClientVariables? <==> c.ClientConstants?) // types of c & v agree
...
module DistributedSystem {
  ...
  lemma PseudoLiveness(c: Constants) 
  {
/*{*/
/*}*/
  }
